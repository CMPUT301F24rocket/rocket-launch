...
public class Event {
    ...
    /**
     * Author: Kaiden
     * get sampleAmount of random userId's from event waitlist and remove and return them
     * @param sampleAmount
